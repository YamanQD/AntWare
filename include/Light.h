...
public:
   ...
   * light. \param diffuse The diffuse color vector (unsigned normalized RGBA)
   * of the light. \param specular The specular color vector (unsigned
   * normalized RGBA) of the light. \param type LightType of the light. \param
   * position The position of the light, unused in LightType::DIRECTIONAL.
   ...
   * LightType::SPOT. \param parent The parent of the light.
   */
