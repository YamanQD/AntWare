...
namespace aw
{
	...
	public:
		 ...
		 *
		 * \param ambient The ambient color vector of the material.
		 * \param diffuse The diffuse color vector of the material.
		 * \param specular The specular color vector of the material.
		...
		/** \brief Creates a material using predefine parameters, check out the implementation
		 ...
		 *
		 * Writes ::ambientLoc, ::diffuseLoc, ::specularLoc, ::shininessLoc and ::alphaLoc
		 * values.
		 *
		 * \param program The shader program of which to extract material fields locations.
		 */
