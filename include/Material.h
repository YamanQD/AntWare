...
namespace aw
{
	...
	public:
           ...
           * vector of the material. \param diffuse The diffuse color vector
           * (unsigned normalized RGBA) of the material. \param specular The
           * specular color vector (unsigned normalized RGBA) of the material.
